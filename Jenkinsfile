pipeline {
    ...
    environment {
        ...
        REPOSITORY_NAME = 'dashboard-service'
            ...
            steps {
                withCredentials([string(credentialsId: 'GitHub_Token', variable: 'GITHUB_TOKEN')]) {
                    script {
                        ...
                        git push https://krityagi:${GITHUB_TOKEN}@github.com/krityagi/dashboard-service.git ${env.BUILD_NUMBER}
                        """
                    }
                }
            }
                ...
                withCredentials([string(credentialsId: 'GitHub_Token', variable: 'GITHUB_TOKEN')]) {
                    script {
                        ...
                        curl -X POST -H "Authorization: token ${GITHUB_TOKEN}" \
                             ...
                             https://api.github.com/repos/krityagi/dashboard-service/dispatches
                        """
                    }
                }
            }
